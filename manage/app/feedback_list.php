...
<head>
  ...
  <title>Mission Shakti | Feedback List</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                       ...
                       if(isset($_GET['district']) && !empty($_GET['district'])){
                          $result = $user->get_district_feedback_list($_GET['district']);
                        }
                        else{
                  ...
                  <tr>
                    ...
                    <td><div class="rating-bar">
                        <?php
                                        $rating_count  = $front->district_rating_count($row['district']);
                                        $rating_sum    = $front->district_rating_sum($row['district']); 
                                   ...
                                   <small class="text-muted"><?php echo number_format($rating,2); ?></small></td>
