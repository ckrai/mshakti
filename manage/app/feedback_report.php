...
<head>
  ...
  <title>Mission Shakti | Feedback Report</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      ...
                      $result = $application->get_feedback_report();
                      $i=0;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="feedback_list?district=<?php echo $row['district'];?>" class="btn btn-tbl-edit btn-xs btn-primary">
