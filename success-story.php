...
<head>
    ...
    <!-- Title -->
    <title>Mission Shakti | Success Story</title>
...
<body>
            ...
            <div class="container">
                <div class="text-center text-white ">
                    ...
                    <ol class="breadcrumb text-center">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">Success Story Upload</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-lg-8 offset-lg-2">
                        <div class="card">
                            <div class="card-header" style="background-color: #FDD9AE;">
                                <p class="text-start fs-16" style="margin-top: 10px;"><b>Upload Success Stories for Misssion Shakti Event</b></p>
                            </div>
                                ...
                                <form id="form">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="form-group">
                                                <input type="file" class="custom-file-input form-control" id="file" name="file" accept=".jpg, .jpeg, .png, .mp4" disabled>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-12">
                                            <div class="input-group form-group">
                                                <textarea class="form-control" aria-label="With textarea" style="height:200px;" disabled id="story" name="story" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    </br>
    ...
    <script>
        $('#form').submit(function() { 
            ...
            $('#status').html('<div class="alert alert-info" role="alert">Please wait while we are uploading your data...</div>');
            $.ajax({
                    ...
                    error: function(jqXHR, exception) {
                        $('#status').append('<div class="alert alert-warning" role="alert">' + response + '</div>');
                    },
                    success: function(response) {
                        $('#form')[0].reset();
                        $('#status').html('<div class="alert alert-success" role="alert">' + response + '</div>');
                    }
                });
