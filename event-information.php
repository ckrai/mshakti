                        ...
                        <ul class="list-group mb-0">
                          <li class="list-group-item">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-primary text-primary"></i> <?php echo "Supervisor : " . $row['supervisor_name'] . " (" . $row['supervisor_id'] . ")"; ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-success text-success"></i> <?php echo "Coordinator : " . $row['coordinator_name'] . " (" . $row['coordinator_id'] . ")"; ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-info text-info"></i> <?php echo "District : " . $row['district'] ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-warning text-warning"></i> <?php echo "Started on : " . $row['start_date']; ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-primary text-primary"></i> <?php echo "Completed on : " . $row['end_date']; ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-success text-success"></i> <?php echo "Status : " . $row['e_status']; ?>
                            </a>
                          </li>
                          <li class="list-group-item ">
                            <a href="#" class="text-dark">
                              <i class="fa fa-file-text-o bg-info text-info"></i> <?php echo "Address : " . $row['address']; ?>
                            </a>
                          </li>
                        </ul>
                      </div>
              ...
              <div class="card">
                ...
                <div class="card-body p-0">
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        <td><a class="text-dark"><i class=""></i><?php echo "Event Id" ?></a></td>
                        <td> <?php echo  $row['id'] ?></td>
                      </tr>
                      <tr>
                        <td><a class="text-dark"><i class=""></i><?php echo "Supervisor" ?></a></td>
                        <td> <?php echo $row['supervisor_name'] . '-' . $row['supervisor_id']; ?></td>
                      </tr>
                      <tr>
                        <td><a class="text-dark"><i class=""></i><?php echo "Coordinator" ?></a></td>
                        <td> <?php echo $row['coordinator_name'] . '-' . $row['coordinator_id']; ?></td>
                      </tr>
                      <tr>
                ...
                <div class="wideget-user-tab">
                  <div class="tab-menu-heading">
                    <div class="tabs-menu1">
                      <ul class="nav">
                        <li>
                          <a href="#event_details" data-bs-toggle="tab" class="active">Details</a>
                        </li>
                        <li>
                          <a href="#event_trainee" data-bs-toggle="tab">Trainee</a>
                        </li>

                        <li>
                          <a href="#event_image" data-bs-toggle="tab">Picture</a>
                        </li>
                        <li>
                          <a href="#event_registration" data-bs-toggle="tab">Registration</a>
                        </li>
                        <li>
                          <a href="#event_mudra" data-bs-toggle="tab">Mudra</a>
                        </li>
                        <li>
                          <a href="#event_attendance" data-bs-toggle="tab">Attendance</a>
                        </li>
                        <li>
                          <a href="#event_trainer" data-bs-toggle="tab">Trainer</a>
                        </li>
                        <li>
                  ...
                  <div class="card-body p-0">
                    <div class="border-0">
                      <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="event_details">
                          <div class="card-body p-0">
                            <table class="table table-bordered">
                              <tbody>
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Trainee Registered</td>
                                  <td>
                                    <?php $tc = new Front();
                                    $tc_result = $tc->event_trainee_count($event_id);
                                    echo "<strong>" . $tc_result . "</strong>";
                                ...
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Registration Form Upload</td>
                                  <td>
                                    <?php $trc = new Front();
                                    $trc_result = $trc->event_trainee_registration_form_count($event_id);
                                    echo "<strong>" . $trc_result . "</strong>";
                                ...
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Mudra Form Upload</td>
                                  <td>
                                    <?php $mfc = new Front();
                                    $mfc_result = $mfc->event_trainee_mudra_form_count($event_id);
                                    echo "<strong>" . $mfc_result . "</strong>";
                                ...
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Attendance Sheet Upload</td>
                                  <td>
                                    <?php $ac = new Front();
                                    $ac_result = $ac->event_trainee_attendance_form_count($event_id);
                                    echo "<strong>" . $ac_result . "</strong>";
                                    ?>
                                  </td>
                                </tr>

                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Picture Upload</td>
                                  <td>
                                    <?php $pc = new Front();
                                    $pc_result = $pc->event_trainee_picture_count($event_id);
                                    echo "<strong>" . $pc_result . "</strong>";
                                    ?>
                                  </td>
                                </tr>
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Trainer</td>
                                  <td>
                                    <?php $tc = new Front();
                                    $tc_result = $tc->event_trainer_count($event_id);
                                    echo "<strong>" . $tc_result . "</strong>";
                                    ?>
                                  </td>
                                </tr>
                                <tr>
                                  <td><i class="bg-primary text-primary"></i>Guest</td>
                                  <td>
                                    <?php $gc = new Front();
                                    $gc_result = $gc->event_guest_count($event_id);
                                    echo "<strong>" . $gc_result . "</strong>";
                                    ?>
                                  </td>
                                </tr>
                        ...
                        <div class="tab-pane" id="event_trainee">
                          <div class="card-body">
                              ...
                              <table class="table table-bordered table-hover  mb-0">
                                <thead class="text-white text-nowrap" style="background-color: #FDD9AE;">
                                  <tr>
                                    ...
                                    <th class="text-white">Aadhaar</th>
                                ...
                                <tbody>
                                  ...
                                  $result    = $alltrainee->get_event_trainee($event_id);
                                  $i = 0;
                        ...
                        <div class="tab-pane" id="event_registration">
                          <div class="card-body">
                            <div class="row"> <?php
                                              $allevent  = new Front();
                                              $result    = $allevent->get_event_registration($event_id);
                                              if ($result->rowCount() > 0) {
                                                while ($rowa = $result->fetch(PDO::FETCH_ASSOC)) {
                                              ?> <div class="col-xl-3 col-md-6">
                                    <div class="card overflow-hidden">
                                      <div class="item-card7-img">
                                        <div class="item-card9-imgs">
                                          <a href="APIs/images/registration/<?php echo $rowa['name']; ?>" target="_blank"></a>
                                          <img class="cover-image" src="APIs/images/registration/<?php echo $rowa['name']; ?>" class="h-100">
                                        </div>
                                      </div>
                                    </div>
                                  </div> <?php }
                                  ...
                                  <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="support-service bg-white br-2">
                                      <h6>Registration Image Not Available</h6>
                                    </div>
                                  </div>
                                </div> <?php } ?> </div>
                          </div>
                        ...
                        <div class="tab-pane" id="event_mudra">
                          <div class="card-body">
                            <div class="row"> <?php
                                              $allevent  = new Front();
                                              $result    = $allevent->get_event_mudra($event_id);
                                              if ($result->rowCount() > 0) {
                                                while ($rowa = $result->fetch(PDO::FETCH_ASSOC)) {
                                              ?> <div class="col-xl-3 col-md-6">
                                    <div class="card overflow-hidden">
                                      <div class="item-card7-img">
                                        <div class="item-card9-imgs">
                                          <a href="APIs/images/mudra/<?php echo $rowa['name']; ?>" target="_blank"></a>
                                          <img class="cover-image" src="APIs/images/mudra/<?php echo $rowa['name']; ?>" class="h-100">
                                        </div>
                                      </div>
                                    </div>
                                  </div> <?php }
                                  ...
                                  <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="support-service bg-white br-2">
                                      <h6>Mudra Image Not Available</h6>
                                    </div>
                                  </div>
                                </div> <?php } ?> </div>
                          </div>
                        ...
                        <div class="tab-pane" id="event_attendance">
                          <div class="card-body">
                            <div class="row"> <?php
                                              $allevent  = new Front();
                                              $result    = $allevent->get_event_attendance($event_id);
                                              if ($result->rowCount() > 0) {
                                                while ($rowa = $result->fetch(PDO::FETCH_ASSOC)) {
                                              ?> <div class="col-xl-3 col-md-6">
                                    <div class="card overflow-hidden">
                                      <div class="item-card7-img">
                                        <div class="item-card9-imgs">
                                          <a href="APIs/images/attendance/<?php echo $rowa['name']; ?>" target="_blank"></a>
                                          <img class="cover-image" src="APIs/images/attendance/<?php echo $rowa['name']; ?>" class="h-100">
                                        </div>
                                      </div>
                                    </div>
                                  </div> <?php }
                                  ...
                                  <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="support-service bg-white br-2">
                                      <h6>Attendance Image Not Available</h6>
                                    </div>
                                  </div>
                                </div> <?php } ?> </div>
                          </div>
                        ...
                        <div class="tab-pane" id="event_trainer">
                          <div class="card-body">
                            <div class="table-responsive border-top mb-0 ">
                              <table class="table table-bordered table-hover  mb-0">
                                <thead class="text-white text-nowrap" style="background-color: #FDD9AE;">
                                  <tr>
                                    ...
                                    <th class="text-white">Training Date</th>
                                ...
                                <tbody>
                                  <?php
                                  $alltrainee  = new Front();
                                  $result    = $alltrainee->get_event_trainer($event_id);
                                  $i = 0;
                                  while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    $i++;
