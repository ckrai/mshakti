   ...
   <head>
      ...
      <script>
         ...
         function validateForm() {
           ...
           var nameErr = dobErr = mobileErr = aadharErr =pan_noErr = districtErr = addressErr = businessErr = vahanErr = true;
           ...
           // Prevent the form from being submitted if there are any errors
            if((nameErr || mobileErr || aadharErr || pan_noErr || addressErr ||  districtErr || dobErr || businessErr || vahanErr) == true) {
              return false;
            } 
