...
<?php 
   if(isset($_POST['submit']) AND $_POST['name']){
         ...
         if($check>0){
            ...
            echo 'window.location = "erickshaw-application";';
            echo '</script>';
            ...
            $row = $front->add_ev_application(ucwords(strtolower($name)),$dob,$mobile,$a_mobile,$aadhar,$pan_no,ucwords(strtolower($address)),$email,$district,ucwords(strtolower($business)),$vahan,'0');
