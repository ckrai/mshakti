...
<?php 
   ...
   if(isset($_POST['submit']) AND $_POST['name']){
         ...
         $user = new User();
         $check = $user->training_check_aadhar($aadhar);
         if($check>0){
            ...
            $row = $user->add_training_application(ucwords(strtolower($name)),$dob,$mobile,$a_mobile,ucwords(strtolower($address)),$aadhar,$district,$supervisor);
