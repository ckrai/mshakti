      ...
      <script>
         ...
         function validateForm() {
           ...
           var supervisorErr= nameErr = dobErr = mobileErr = aadharErr =pan_noErr = districtErr = addressErr = businessErr = vahanErr = true;
            ...
            // Validate id
            if(supervisor == "Select") {printError("supervisorErr", "Please select valid id");}
            else {printError("supervisorErr", "");supervisorErr = false;}
            ...
            // Validate pan number
            if(pan_no == "") { printError("pan_noErr", "Please enter your PAN number");} 
            else {
            var regex = /^[A-Z]{5}[0-9]{4}[A-Z]{1}$/;
              if(regex.test(pan_no) === false) {printError("pan_noErr", "Please enter a valid PAN number");} 
              else{printError("pan_noErr", ""); pan_noErr = false }
            }
            ...
            // Validate business
            if(business == "") {printError("businessErr", "Please enter your business");}
            else {printError("businessErr", "");businessErr = false;}
            ...
            // Validate vahan
            if(vahan == "Select") {printError("vahanErr", "Please select your vahan"); }
            else { printError("vahanErr", "");vahanErr = false; }
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-8">
                     <div class="card">
                        ...
                        <div class="card-body pb-3">
                           ...
                           <form name="regForm" onsubmit="return validateForm()" action="apply-erickshaw" method="post" enctype="multipart/form-data">
                              <div class="row">
                              <div class="col-xl-12">
                                <div class="form-group">
                                  ...
                                  <?php
                                     ...
                                     $result = $supervisor->get_supervisor_list(); 
                                     while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                      echo '<option>'.$row['firm_name'].' ('.$row['u_id'].')</option>';
                                    }?>
                                 </select>
                               <div class="error" id="supervisorErr"></div>
                                   <p class="text-start fs-12" style="margin-top: 5px; color: #DF1755;"><b>नोट:  यदि आप सर्वेक्षक हैं तो अपनी आईडी चुनें # यदि आप अपने लिए आवेदन कर रहे हैं तो स्वयं (0) चुनें</b></p>
                               </div>
                             </div>
                                 <!-- <div class="col-xl-12">
                                   <div class="form-group">
