    ...
    <script>
         ...
         function validateForm() {
           ...
           var nameErr = mobileErr =dateErr= districtErr = trainingQualityErr = trainingKitErr =foodQualityErr = satisfactionErr=benefitErr=futureTrainingErr =true;
            ...
            // Validate date
            if(date == "") {printError("dateErr", "Please select training date");} 
            else {printError("dateErr", "");dateErr = false;} 
            ...
            if(district == "Select") {printError("districtErr", "Please select your district");}
             ...
             // Validate district
             if(trainingQuality == "Select") {printError("trainingQualityErr", "Please select training quality");}
            else {printError("trainingQualityErr", "");trainingQualityErr = false;}

             // Validate district
             if(trainingKit == "Select") {printError("trainingKitErr", "Please select training kit");}
            else {printError("trainingKitErr", "");trainingKitErr = false;}

             // Validate district
             if(foodQuality == "Select") {printError("foodQualityErr", "Please select food quality");}
            else {printError("foodQualityErr", "");foodQualityErr = false;}

             // Validate district
             if(satisfaction == "Select") {printError("satisfactionErr", "Please select overall satisfaction");}
            else {printError("satisfactionErr", "");satisfactionErr = false;}

             // Validate district
            if(benefit == "Select") {printError("benefitErr", "Please select benefit");}
            else {printError("benefitErr", "");satisfactionErr = false;}    

             // Validate district
             if(futureTraining == "Select") {printError("futureTrainingErr", "Please select future training");}
            else {printError("futureTrainingErr", "");futureTrainingErr = false;} 
